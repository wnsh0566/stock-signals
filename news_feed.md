...
- **D+7** (08/12) ⭐⭐⭐ 미국 7월 CPI 21:30 KST — 코어 컨센 2.5%(S1~S2/S3 경계선)
- **D+6** (08/13) ⭐⭐⭐ FTD 유효창 마감(day1=7/31·창 8/5~8/13) — 리셋은 종가 5,594 이탈만
- **D+6** (08/13) ⭐⭐ 한국 선물옵션 동시만기 — FTD 창 마지막날과 중첩, 수급 왜곡 주의
- **D+5** (08/14) ⭐ 자금 +3,000만 입금 — BEAR 해제 전 봉인(§14-1)
- **D+1** (~08/18) ⭐⭐ 보험 4사 2Q 실적(코리안리·DB손보·삼성화재·현대해상) — 발표일 미정, DART 확인 필요
- **D-8** (~08/27) ⭐⭐⭐ 잭슨홀 심포지엄 — 워시 첫 기조연설
- **D-9** (~08/28) ⭐⭐⭐ 엔비디아 실적 — 심판 A 복귀 촉매
- **D-12** (~08/31) ⭐⭐ USTR 301조 '과잉생산' 판정 — 반도체·기계·조선 대상, 코어(금융) 무풍
- **D-12** (~08/31) ⭐⭐ 금융위 지배구조 개편안(회장 연임 제한) — 당정 이견에 법제화 불투명(P8)
- **D-12** (~08/31) ⭐ 한은 금통위 — 원화·유동성
...
- `08-19 15:42` 국힘·오세훈 '부동산 토론회'서 "재개발·재건축 풀어야"... 공급 대책 마련 촉구 - 로이슈 — *로이슈*
- `08-19 15:19` 국힘·오세훈, 8·13 부동산 대책 정조준…“세금보다 공급이 먼저” - 미디어이슈 — *미디어이슈*
...
## 🌍 연준·금리
- `08-19 15:56` Won surges to 1,300 range as Fed rate hike bets fade; further gains seen limited - KED Global — *KED Global*
- `08-19 15:20` Won breaks below 1,400 per dollar - Korea JoongAng Daily — *Korea JoongAng Daily*
